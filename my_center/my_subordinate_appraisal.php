...
if (isset($_POST['user'])) {
 ...
 $get_app = "SELECT * FROM appraisals WHERE app_employee='$user' AND from_year='$from' AND to_year='to'";
    $run_app = mysqli_query($link, $get_app);
      while ($app_row=mysqli_fetch_array($run_app)) 
    {
      //$emp_id=$app_row["employee_id"];
    }
                            ...
                            <div class="row align-center" >
                                ...
                                <div class="col-lg-6 col-md-10 col-sm-12 col-sx-12 border-bottom-custom border-left-col">
                                    <div class="row align-center margin-off ">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 border-left-col border-right-col">
                                ...
                                <h2 class="panel-title" align="center" style="font-size:20px;">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <i class="more-less glyphicon glyphicon-plus"></i>
                                         Previous Years Appraisals Rating
                                    </a>
                                </h2>
                            </div>
                                        ...
                                        <div class="table-responsive-lg" style="width: 100%;">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col">KPI-3</th>
                                                    <th scope="col">KPI-4</th>
                                                    <th scope="col">KPI-5</th>
                                                    <th scope="col">KPI-6</th>
                                                    <th scope="col">KPI-7</th>
                                                    <th scope="col">KPI-8</th>
...
$score_tot=0;
$rate=0;
    $get_app = "SELECT * FROM appraisals WHERE app_employee='$user'";
    $run_app = mysqli_query($link, $get_app);
      while ($app_row=mysqli_fetch_array($run_app)) 
    {
      
    $year_app="Jul " . $app_row['from_year'] . " - Jun " . $app_row['to_year'];
    ...
    $score_tot=$app_row['app_gross'];
    $rate=$app_row['app_rating'];
?>
        <tbody>
            <tr>
                <td><?php echo $year_app; ?> </td>
    ...
    <?php } ?>
					 ...
					 <div class="row margin-off align-center bordered-column section-heading">
                                    ...
                                    <ol class="ordered-list">
                                        <li class="list-element">
                                            <div class="row align-center margin-off" >
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="planning" name="planning">
                                        ...
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="controlling" name="controlling">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
                                        ...
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="decesion" name="decesion">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
                        ...
                        <div class="panel panel-default bordered-column" style="margin-top: 5px;">
                            <div class="row margin-off align-center bordered-column section-heading">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-align-custom">
                            <h1> SECTION 2: PROFESSIONAL ATTRIBUTES</h1>
                        </div>
                    </div>
                                    ...
                                    <ol class="ordered-list">
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg"  id="knowledge" name="knowledge">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
                                        ...
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="professional" name="professional">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
  ...
  <div class="col-md-2 col-sm-4 col-4 custom-select-div">
    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="task" name="task">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
                                        ...
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="platform" name="platform">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
                                        ...
                                        <li class="list-element">
                                            <div class="row align-center margin-off">
                                                ...
                                                <div class="col-md-2 col-sm-4 col-4 custom-select-div">
                                                    <select class="form-select form-select-lg custom-select" aria-label=".form-select-lg" id="integrated" name="integrated">
                                                        <option selected>Choose rating</option>
                                                        <option value="0.5">0.5</option>
                                                        <option value="1">1</option>
                                                        <option value="1.5">1.5</option>
        ...
        if(isset($_POST['submit']))
{
    ...
    $tot_score=$planning+$controlling+$decesion+$knowledge+$professional+$task+$platform+$integrated;
    $tot_score=28;
    $result = $tot_score / 8;

    $sql=mysqli_query($link, "UPDATE appraisals SET 
       app_score1='$planning', app_score2='$controlling', app_score3='$decesion', app_score4='$knowledge', app_score5='$professional', app_score6='$task', app_score7='$platform', app_score8='$integrated',
       app_gross='$tot_score', app_rating='$result'
    WHERE app_employee='$user' AND from_year='$from_year'") or die(mysqli_error($link)); 

    header("location:my_subordinate_assessment.php?user=$user&period=$from_year");  
  }
