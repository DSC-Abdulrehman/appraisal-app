                                ...
                                <div class="col-md-10 col-sm-8 padding-off">
                                            <div class="row align-center margin-off ">
												...
												<div class="col-md-7 col-sm-10s col-12 border-right-col ">
                                                    <div class="align-center">
													<label for="id_no" class="form-label input-labels">Supervisor Remarks : </label>
                                                    <input type="text" class="form-control" id="sup_rmk" name="sup_rmk" placeholder="Your Comments">
        ...
        if(isset($_POST['submit']))
{
    ...
    $sup_rmk=$_POST['sup_rmk'];

    $sql=mysqli_query($link, "UPDATE appraisals SET 
       app_sup_id='$emp_supid', app_sup_rmk='$sup_rmk' 
       WHERE app_employee='$user' AND from_year='$from_year'") or die(mysqli_error($link));
   	  header("location:my_subordinate_appraisal_view.php?user=$user&period=$period");
