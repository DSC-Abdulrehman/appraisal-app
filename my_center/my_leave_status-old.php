...
<div class="col-sm-2">
    ...
    <label for="emp_cell" class="control-label mb-1"><b>Status</b></label>
      ...
      <select name="stat" style="height: 50px; width: 150px;";>
...
if ($from_date=="") {
  ...
  $w_switch="full";
   ...
   $get_leave_tbl = "SELECT * FROM employee_leave_record WHERE leave_emp_id='$user' AND leave_type>0";
...
$leave_type_id=0;
  ...
  if ($wk_status=="Pending" OR $wk_status=="applied") {
...
<div class="row">
	<div class="panel panel-danger" style="width: 1220px; margin-left: 10px; margin-top: -20px;">
...
<table width="1080" border="1">
  <tr>
    ...
    <td width="90">&nbsp; App. Date</td>
    <td width="100">&nbsp; Leave Type </td>
    <td width="90">&nbsp; From Date</td>
    <td width="90">&nbsp; To Date</td>
    <td width="90">&nbsp; # of Days </td>
...
?>	
  ...
  <tr>
    <td width="90">&nbsp; <?php echo $emp; ?></td>
    <td width="180">&nbsp; <?php echo $name  . " " . $lname; ?></td>
    <td width="90">&nbsp; <?php echo $wk_date_applied; ?></td>
    <td width="100">&nbsp; <?php echo $wk_title; ?></td>
    <td width="90">&nbsp;<?php echo $wk_from_date; ?></td>
    <td width="90">&nbsp; <?php echo $wk_to_date; ?></td>
    <td width="90">&nbsp; <?php echo $wk_days; ?></td>
...
//$sql = "DELETE FROM leave_work_table WHERE wk_id='$emp' AND wk_from_date='$wk_from_date' AND wk_to_date='$wk_to_date'") or die(mysqli_error($link));
...
<?php include 'footer.php';?>
    ...
    <script src="../dsc-management/ds_leave/assets/js/jquery-2.1.4.min.js"></script>
    <script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script type="text/javascript" src="../dsc-management/ds_leave/assets/js/jquery.timepicker.min.js"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js"></script>
    <script src="../dsc-management/ds_leave/assets/js/plugins.js"></script>

    <script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap4.min.js"></script>
    <script src="../dsc-management/ds_leave/assets/js/datatables.min.js"></script>

    <script src="../dsc-management/ds_leave/assets/js/main.js"></script>
    <script src="../dsc-management/ds_leave/assets/js/common.js"></script>
