...
<div class="col-lg-6 col-md-10 col-sm-12 col-sx-12 border-bottom-custom border-left-col">
 ...
 <div class="col-lg-6 col-md-6 col-sm-6" style="">
  <label for="id_no" >Name : &nbsp; <?php echo $name; ?>
</label>
 </div>
 </div>
  </div>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-sx-4 border-bottom-custom border-left-col">
  ...
  <div class="row align-center border-bottom-custom">
    ...
    ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <select id="departure" onChange="getLeave(this)" name="departure" class="form-control" style="height: 34px;">
          <option>Departing Carrier</option>
     <?php
        $get_type1 = "select * from carrier_type";
        $run_type1= mysqli_query($link,$get_type1);
        while ($type1_row=mysqli_fetch_array($run_type1)) {
    $leave_type_id=$type1_row['carr_type_id'];
  $leave_type_title=$type1_row['carr_type_name'];
  ...
  <div class="row align-center border-bottom-custom">
    ...
    ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
        <select id="return" onChange="getLeave(this)" name="return" class="form-control" style="height: 34px;">
          <option>Returning Carrier</option>
     <?php
        $get_type2 = "select * from carrier_type";
        $run_type2= mysqli_query($link,$get_type2);
        while ($type2_row=mysqli_fetch_array($run_type2)) {
    $leave_type_id=$type2_row['carr_type_id'];
  $leave_type_title=$type2_row['carr_type_name'];
...
{   
 ...
 //$departure=mysqli_real_escape_string($link, $_POST['departure']);
    ...
    $sql=mysqli_query($link, "INSERT INTO employee_trips (trip_id,emp_id,emp_grade,sup_id,exp_travel_date,exp_return_date,trip_from,trip_to,return_from,return_to,trip_purpose,trip_days,trip_travel_entitlement,trip_carrier_from,trip_carrier_to,trip_hotel_ent_1,trip_hotel_ent_2,trip_daily_allonace,trip_taxi_fare,status)

    VALUES('','$user','$grade','$sup_id','$date1','$date2','$city1','$city2','$city3','$city4','$purpose','$days2','$travel_ent','$departure','$return','$hotel_ent1','$hotel_ent2','$daily_ent','$taxi_ent','applied')") or die(mysqli_error($link));
