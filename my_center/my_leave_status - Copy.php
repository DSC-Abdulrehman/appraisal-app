...
?>	
  ...
  <tr>
    ...
    <form action="test1.php?emp=<?php echo $emp; ?>&user=<?php echo $user; ?>&desig_id=<?php echo $desg_id; ?>&wk_from_date=<?php echo $wk_from_date; ?>&wk_to_date=<?php echo $wk_to_date; ?>" onSubmit="return validateForm()" enctype="multipart/form-data" name="EmpForm1" id="EmpForm1" method="post">
    <td width="100">
      <?php 
