...
<div class="">
  ...
  <div class="card_panel">
     <div class="col-sm-10"> 
	   <div class="panel panel-primary" style="margin-top: 2px; width: 1130px;">
               <div class="row">&nbsp;</div>
...
<table width="1100" border="1">
  ...
  <tr>
    ...
    <td colspan="3" align="center"> <b>New Values </b></td>
    <td width="120" rowspan="2">&nbsp; <b>Action</b></td>
    </tr>
  <tr>
     <td width="100">&nbsp; <b>Time In</b></td>
     <td width="100">&nbsp; <b>Time Out</b></td>
     <td width="100">&nbsp; <b>Time In</b></td>
     <td width="100">&nbsp; <b>Time Out</b></td>
     <td width="200">&nbsp; <b>Reasons</b></td>
...
<?php } ?>
  ...
  <form action="hr_update_new_time.php?user=<?php echo $user; ?>&date1=<?php echo $att_date; ?>&id=<?php echo $id; ?>" name="EmpForm1" id="EmpForm1" method="post"> 

    <td width="100">&nbsp;<b> <?php echo $att_date; ?></b></td>
    <td width="100">&nbsp; <b><?php echo $att_time_in; ?></b></td>
    <td width="100">&nbsp; <b><?php echo $att_time_out; ?></b></td>
    <td width="100">&nbsp;  <b><?php echo $att_logged_time; ?></b></td>
      <input name='id' type='hidden' hidden value="<?php echo $id ?>"/>
    <td width="120">
    ...
    <td width="120">
      ...
      <td width="200">
      <input  name="resons" id="resons" type="text" class="form-control" placeholder="Mention Resons" value=<?php echo $resons; ?>></td>
      <td width="120">
      <div class="button" style="width: 120px;">
            <button type="submit" class="btn" id="update" name="update"><b>Click to Update</b></button>
            </div>
      </td>
      </div>
      </form>
        ...
        if(isset($_POST['goback']))
{
      ...
      header("Location: hr_view_attendance_summary.php?user=$user2");
  }
