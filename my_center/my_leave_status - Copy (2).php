...
<div class="row">
	<div class="panel panel-danger" style="width: 1110px; margin-left: 15px; margin-top: -20px;">
...
?>	
  ...
  <tr>
    ...
    <td width="120">&nbsp; <?php echo $wk_status; ?></td>
	 ...
	 <!--form action="test1.php?emp=<?php echo $emp; ?>&user=<?php echo $user; ?>" onSubmit="return validateForm()" enctype="multipart/form-data" name="EmpForm" id="EmpForm" method="post"-->

    <form action="test.php?emp=<?php echo $emp; ?>&user=<?php echo $user; ?>" onSubmit="return validateForm()" enctype="multipart/form-data" name="EmpForm1" id="EmpForm1" method="post">
    <td width="100">
      <?php 
