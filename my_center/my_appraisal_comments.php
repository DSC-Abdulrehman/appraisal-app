...
<div class="row align-center margin-off border-bottom-custom">
   <div class="col-md-10 col-sm-8 padding-off">
    <div class="row align-center margin-off ">
       <div class="col-md-3 col-sm-6 col-12 border-right-col border-left-col">
        <div class="align-center">
        <label for="id_no" class="form-label input-labels" >Employee's Comments : </label> 
                                                   
    </div>
    </div>
   
    <div class="col-md-9 col-sm-10s col-12 border-right-col ">
        <div class="align-center">
        <input type="text" id="emp_cmnt" name="emp_cmnt" class="form-control" placeholder="Please insert your comments"><?php echo $emp_cmnt; ?>
...
<div class="panel-body-sub-part" style="margin-top: -10px;">
                        
     
                
            </section>
            <div class="button-div">
            <button type="submit" class="btn btn-primary submit-btn" id="submit" name="submit"> Go </button>
            </div>
            </form>
                </div>
            </div>
...
{
     $emp_cmnt=$_POST['emp_cmnt'];

     $sql=mysqli_query($link, "UPDATE appraisals SET 
       app_emp_rmk='$emp_cmnt'
    WHERE app_employee='$user'AND from_year='$period'") or die(mysqli_error($link));  

     header("location:my_appraisals.php?user=$user");
  }
