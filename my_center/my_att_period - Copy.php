...
<table width="1100" border="2">
  ...
  <tr>
    <td> <label class="form-control"><a href="my_single_month_attendance.php?user=<?php echo $user ?>& month=<?php echo $att_month ?>& year=<?php echo $att_year ?>"><?php echo $month_year; ?>&nbsp; Detail</a>
              </label></td>
    <td> <label class="form-control">&nbsp; <?php echo $att_hrs; ?></label></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
