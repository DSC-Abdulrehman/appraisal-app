<?php
 ...
 $year="Jul 2023 - Jun 2024";
   ...
   $get_app_details = "SELECT * FROM appraisals WHERE app_sup='$emp_sup_id'";
       ...
       $get_emp_details = "SELECT * FROM employee_record WHERE employee_serial='$emp_id'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      <div class="">
         <?php include 'sidebar-appraisals.php';?> 
         <div class="col-sm-9">
                     ...
                     <div class="panel panel-success">
                        <div class="panel-heading" style="background-color: orange; color: white; margin-left: -15px; margin-right: -15px; margin-top: 0px;">
                           <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Rating & Corresponding Increment Percentage</a>
                           </h4>
                        </div>
                     ...
                     <div class="col-sm-7">
                        <form id="form1" name="form1" method="post" action="">
                           <div class="panel panel-primary" style="height: 565px;">
                              <div class="panel-heading"><b><?php echo str_repeat('&nbsp;', 45); ?>&darr; A &nbsp; p &nbsp; p &nbsp; r &nbsp; a &nbsp; i &nbsp; s &nbsp; a &nbsp; l &nbsp; &nbsp; &nbsp;  F &nbsp; o &nbsp; r &nbsp; m &darr;  <?php echo str_repeat('&nbsp;', 45); ?><?php echo $user; ?></b></div>
  ...
  $sql=mysqli_query($link, "UPDATE appraisals SET 
      ...
      WHERE app_employee='$emp_id'") or die(mysqli_error($link));
