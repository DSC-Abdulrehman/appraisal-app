...
<div class="col-lg-3 col-md-3" >
  <input type="text" class="form-control" name="carr_dep" id="carr_dep" placeholder="Booking in
  " />
  </div>
    ...
    <div class="col-lg-3 col-md-3" >
  <input type="text" class="form-control" name="carr_ret" id="carr_ret" placeholder="Booking in
  " />
  </div>
...
if (isset($_POST['submit'])) {
    ...
    $hotel_id=mysqli_real_escape_string($link, $_POST['hotel']);
    ...
    $carr_dep=mysqli_real_escape_string($link, $_POST['carr_dep']);
     $carr_ret=mysqli_real_escape_string($link, $_POST['carr_ret']);
//}
...
$sql=mysqli_query($link, "UPDATE employee_trips SET trip_carr_start='$carrier1', trip_date_start='$date_fr', carr_code_start='$carr_dep', trip_carr_return='$carrier2', trip_date_return='$date_to', carr_code_return='$carr_ret', 
