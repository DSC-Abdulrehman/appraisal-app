...
?>
        ...
        <div class="content mt-3">
            <div class="tab-content"><!-- search_case_status starts here -->
                  ...
                  <div id="employees_report" class=""><!-- removed "tab-pan fade in" -->
                   ...
                   <div class="col-lg-12">
                    <form action="grades_form.php" method="Post" enctype="multipart/form-data" class="form-horizontal">
                     <div class="card">
 ...
 -->
                         <table id="employees_report_table" class="table table-striped table-bordered display" cellspacing="0" width="100%">
                           <thead>
                             <tr>
                               <th scope="col"> <i class="fa fa-star-o"></i> Grade ID.</th>
                               <th scope="col"> <i class="fa fa-money"></i> Basic Pay</th>
                               <th scope="col"> <i class="fa fa-plus-square-o"></i> House Allowance</th>
                               <th scope="col"> <i class="fa fa-plus-square-o"></i> Conveyance Allowance</th>
                               <th scope="col"> <i class="fa fa-plus-square-o"></i>Communication Allowance</th>
                               <th scope="col"> <i class="fa fa-plus-square-o"></i> Others</th>
                               <th scope="col"> <i class="fa fa-minus-square-o"></i> Absence Adjustment</th>
                               <th scope="col"> <i class="fa fa-minus-square-o"></i>Advance Adjustment</th>
                               <th scope="col"> <i class="fa fa-minus-square-o"></i>Core Adjustment</th>
                               <th scope="col"> <i class="fa fa-minus-square-o"></i> Phone/Others </th>
                               <th scope="col"> <i class="fa fa-minus-square-o"></i> Incom Tax adjustment</th>
                               <!--<th scope="col"> <i class="fa fa-wrench"></i> Action</th>-->
                             </tr>
                           </thead>
                           <tbody>
<?php 
$sql_select="SELECT * FROM grades";
$result_select=mysql_query($sql_select);
  while ($rows = mysql_fetch_array($result_select)) 
  {
?>
 <tr><td><?php echo $rows['grades_id']?></td>
<!-- <td>
<?php /*?><?php  // echo $rows['grade'];?><?php */?> </td><td>
<?php // echo $rows['salary_month'];?> </td>
<td>-->
...
<td><?php echo $rows['advance_deduction'];?></td>
<td><?php echo $rows['core_deduction'];?></td>
<td><?php echo $rows['phone_others_deduction'];?></td>
<td><?php echo $rows['incom_tax_deduction'];?></td>
<!--<td><span class="fa fa-edit (alias) fa-lg" style="cursor:pointer;border: 1px solid gray;padding: 10px;"></span>-->
 <!-- data-toggle="modal" data-target="#scs_case_details_modal"  //removed these things: --><!--<span></span> '-->
 <!--<span class="fa fa-trash-o fa-lg" style="cursor:pointer;border: 1px solid gray;padding: 10px;"></span></td>--> 
</tr>
<!--<td>                 
<?php // echo $rows['employee_no'];?></td>-->
<?php
}
?>
                           </tbody>
