...
<div class="panel-heading panel-Info" style="margin-top: 0px">
				<h3 class="panel-title" align="center"><b>&darr; Travel Status &darr;</b> </h3>
			</div>
<div class="panel-body">
...
//$get_trip = "SELECT * FROM employee_trips";
  ...
  //}else{
    $get_trip = "SELECT * FROM employee_trips WHERE status='applied'";
  $run_trip = mysqli_query($link, $get_trip) or die(mysqli_error($link));
  //}
...
?>	
  ...
  <tr>
    ...
    <td width="90"><label class="form-control">
      ...
      <input type="submit" class="btn btn-md recommend_appr_btn" name="update" value="update"> </label></td>
	</form>
